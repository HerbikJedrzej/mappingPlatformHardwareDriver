...
TEST(Strategy_TuneMovePID, run){
    ...
    PlatformDrivers::EncoderParser<volatile uint32_t> encoderR(timerRegister, 10000, 100.0);
    PlatformDrivers::EncoderParser<volatile uint32_t> encoderL(timerRegister, 10000, 100.0);
    ...
    PlatformDrivers::DriversPlatform driversPlatform{
        &engineR, &engineL, &encoderMenager, nullptr, nullptr, nullptr, &gpio, nullptr, nullptr, &pid, &batteryObserver
    };
